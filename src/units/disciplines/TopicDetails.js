...
const CreateTopic = (props) => {
  ...
  const [uistate, setUiState] = useState({
    create: "new", selDerivedSectionName: "Select Derived Topic",
  })
  const [newsectionobj, setNewSectionObj] = useState({ access: "" })

  useEffect(() => {
    appglobal.pagetitle = "Topic Details"
    ...
    <BaseLayoutWrapper>
      <Container className="section_detail_card">
        <Row className="mt-4" style={{ marginLeft: "5px" }}>
          ...
          />
          <span className="textstyle">Topic Details</span>
        </Row>
        <hr className="line" />
        <div className="section_wrapper">
          ...
          <div className="input_spacing">
            <Row className="text-left">
              ...
              <div style={{ marginLeft: "15px" }}>
                <label className="labels d-block">Background</label>
                <ImageUpload
                  style={{
                    width: "340px",
                    height: "90px",
              ...
              <Col className="offset-1">
                <label className="labels d-block">Sub subject</label>
                <TextField id="section-standard-basic" style={{ marginTop: "35px" }} />
              </Col>
            </Row>
          </div>
          ...
          <Row>
            ...
            <Col className="text-right">
              <Link to="concept">
                <button className="add_section_btn">+ Add Concepts</button>
              </Link>
            </Col>
          </Row>
        </div>
