...
const PreliminaryDetails = (props) => {
  ...
  useEffect(() => {
    appglobal.pagetitle = "Preliminary Details"
  ...
  const options = {
    ...
    sizePerPageList: [{
      ...
      text: 'All', value: preconcepts.length
    }]
  }
    ...
    <BaseLayoutWrapper>
      <Container className="section_detail_card">
        <Row className="mt-4" style={{ marginLeft: "5px" }}>
          ...
          />
          <span className="textstyle">Preliminary Details</span>
        </Row>
        <hr className="line" />
        <div className="section_wrapper">
          <div className="input_spacing">
            <Row className="text-left">
              <Col>
                <label className="labels d-block"> Preliminary Concepts </label>
          ...
          <div className="input_spacing">
            <Row className="text-left">
              ...
              <Col>
                ...
                <TextField id="section-standard-basic" style={{ marginTop: "45px" }} />
              </Col>
            </Row>
          </div>
